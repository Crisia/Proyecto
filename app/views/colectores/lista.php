...
try
{
  $userMessage = "Colectores registrados en el sistema";
...
try
{
  ...
  if ($idUpdated || $idNew) {
    ...
    if ($idUpdated) {
      $collectorUpdated = Colector::validate($idUpdated, $newName, $newStatus);
    }
    if ($idNew) {
      $collectorUpdated = Colector::validate($idNew, $newName, $newStatus);
      if ($collectorUpdated) {
        $colectores[] = $collectorUpdated;
      }
    }
  }
}
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-body">
            ...
            <div class="panel-body">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  <?php echo $report->getCollectorsTable($colectores, $idUpdated, $collectorUpdated); ?>
                </table>
              </div>
        ...
        <div>
          <?php
          foreach ($colectores as $collecor)
          {
            $id = $collecor->id;
